...
// Content-readiness tracker for the teaching side: which topics have questions, and who is on them.
// Distinct from the student-facing confidence Tracker at /tracker.
export default function Coverage() {
  ...
  return (
    <div>
      <PageHeader title="Content coverage">
