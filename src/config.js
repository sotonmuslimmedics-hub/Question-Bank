...
export const ROLES = [
  { value: 'student', label: 'Student', help: 'Practise questions, read announcements.' },
  { value: 'teacher', label: 'Student teacher', help: 'Also: write questions (reviewed before going live), make teaching slides, log teaching, see the topic tracker.' },
  { value: 'lead', label: 'Academic lead', help: 'Also: review and publish questions, post announcements, edit the topic tracker.' },
